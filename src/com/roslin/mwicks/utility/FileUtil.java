...
public final class FileUtil {
    ...
    public static boolean isZipFileValid(File file) {
        ...
        try {
            ...
            while( ze != null ) {
                ...
                ze.getCrc();
                System.out.println("ze.getCrc(): " + ze.getCrc());
    ...
    public static void ZipWithChecksum(String target) {
    ...
    public static void ZipTextWithChecksum(String targetFile, String sourceDir) {
    	...
    	try {
            ...
            if ( dir.exists() ) {
        		...
        		for (int i = 0; i < files.length; i++) {
        			...
        			System.out.println("Compressing: " + sourceDir + files[i]);
                    
        			
        			FileInputStream fis = new FileInputStream(sourceDir + files[i]);
        			BufferedInputStream bis = new BufferedInputStream(fis, buffer.length);
