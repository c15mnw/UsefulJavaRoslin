...
public class CsvUtil {
     ...
     * @return The InputStream containing the CSV contents (actually a ByteArrayInputStream).
     */
    public static <T extends Object> InputStream formatCsvWithQuotes(List<List<T>> csvList) {
    	
        return formatCsvWithQuotes(csvList, DEFAULT_CSV_SEPARATOR);
    }
     ...
     * @return The InputStream containing the CSV contents (actually a ByteArrayInputStream).
     */
    public static <T extends Object> InputStream formatCsvWithQuotes(List<List<T>> csvList, char csvSeparator) {
        ...
        for (List<T> csvRecord : csvList) {
            ...
            if (csvRecord != null) {
                ...
                csvContent.append(formatCsvRecordWithQuotes(csvRecord, csvSeparator));
            }
     ...
     * @return A String representing a CSV record.
     */
    private static <T extends Object> String formatCsvRecordWithQuotes(List<T> csvRecord, char csvSeparator) {
        ...
        for (Iterator<T> iter = csvRecord.iterator(); iter.hasNext();) {
            ...
            if (object != null) {
                ...
                String field = object.toString(); // Escape quotes.
